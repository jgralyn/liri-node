...
var query = process.argv[3];
	...
	var spotify = new Spotify(keys.spotify);
		consumer_key: SpotifyCredentials.consumer_key,
		consumer_secret: SpotifyCredentials.consumer_secret,
		access_token_key: SpotifyCredentials.access_token_key,
		access_token_secret: SpotifyCredentials.access_token_secret
	});
